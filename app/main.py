...
app = FastAPI(
    ...
    description=(
        "Enterprise Production Backend API for SIH Smart Scrap & E-Waste Valuation, "
        "Exclusive Hindi & Marathi Voice-to-Command Engine, CPCB/SPCB Recycler Geospatial Locator, "
        "and Offline CPU-Optimized Computer Vision Grading Pipeline."
    ),
    docs_url="/docs",
    redoc_url="/redoc"
)

# CORS Configuration for Flutter Mobile Apps & Modern Web Frontends
app.add_middleware(
    CORSMiddleware,
    allow_origins=["*"],
...
async def generic_exception_handler(request: Request, exc: Exception):
    ...
    return JSONResponse(
        ...
        content={
            "detail": "Internal server error occurred. Please consult backend logs.",
            "success": False,
            "error": {
...
def root():
    return {
        ...
        "compliance": "CPCB & SPCB Hazardous & E-Waste Management Rules 2022"
    }
