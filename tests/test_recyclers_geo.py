...
def test_nearest_recycler_with_lat_lon_params(client):
    # Scrap dealer location in Dadar, Mumbai (19.0178, 72.8478)
    # Using strict lat and lon query parameter names
    ...
    # Ecoreco in Mahape Navi Mumbai should be closest (~20km from Dadar)
...
def test_nearest_recycler_with_latitude_longitude_params(client):
    # Scrap dealer location in Shivajinagar, Pune (18.5308, 73.8475)
